...
const OrderHistory = () => {
  ...
  const lastPostIndex = CurrPage * 5;
  const firstpostIndex = lastPostIndex - 5;
  const pagedData = orderData?.slice(firstpostIndex, lastPostIndex);
      ...
      <div className="order-history-container">
        ...
        <div className="order-history-wrapper">
          <Breadcrumbs
            ...
            RouteOne={"My orders"}
            customStyle={{ width: "100%", marginTop: "0px" }}
          />
          <div className="filter-buttons">
            <div className="left-buttons">
              ...
              <button
                ...
                onClick={() => onClickFilterHandler("pending")}
              >
                Not Yet Shipped
              </button>
              <button
                className={selectedFilter === "cancelled" ? "active-btn" : ""}
                onClick={() => onClickFilterHandler("cancelled")}
              >
                Cancelled Orders
              </button>
            </div>
